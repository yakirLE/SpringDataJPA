package com.continuity.springdatajpa.conference.model;
...
public class Registration {
    ...
    public static final String REGISTRATION_REPORT_JPQL =
            "Select new com.continuity.springdatajpa.conference.model.RegistrationReport(r.name, c.name, c.description) " +
